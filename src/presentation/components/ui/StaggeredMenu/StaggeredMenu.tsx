/**
 * StaggeredMenu — adapted from ReactBits (DavidHDev/react-bits)
 * Changes: TypeScript, named export, GSAP from @infrastructure/gsap,
 * dark electric-blue theme, logo as ReactNode instead of img src.
 */
...
export interface StaggeredMenuProps {
  position?: 'left' | 'right'
  /** Pre-layer slide-in colors (2-3 values) */
  colors?: string[]
  items?: StaggeredMenuItem[]
  socialItems?: StaggeredMenuSocialItem[]
  displaySocials?: boolean
  displayItemNumbering?: boolean
  /** Custom logo rendered in the header (ReactNode) */
  logo?: ReactNode
...
export function StaggeredMenu({
  ...
  return (
    ...
    >
      {/* Pre-layers (color sweep before the panel) */}
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#07070a', '#0d1a33']
          const arr = [...raw]
      ...
      >
        <div className="sm-panel-inner">
          ...
          {displaySocials && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Contacto">
              <h3 className="sm-socials-title">Contacto</h3>
